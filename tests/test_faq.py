...
from pages.home import FaqQuestions, Cookies, HomePage
...
class TestQuestions:
    ...
    def setup_and_teardown(self, request):
        ...
        HomePage(driver).open_page_scooter()
    ...
    def test_frequently_asked_questions_are_equal_to_expected(self, request, expected):
